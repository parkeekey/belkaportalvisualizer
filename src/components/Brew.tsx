...
export default function Brew({
  ...
  return (
    <section className="max-w-4xl mx-auto w-full mt-6 pt-4 border-t border-slate-200">
      ...
      <div className="flex gap-3">
        ...
        <div className="flex flex-col gap-2 flex-1 items-center">
          ...
          <div className="w-full" style={{ maxWidth: 260 }}>
            ...
            <div className="flex justify-between text-[7px] text-slate-300 mt-px">
              <span>0</span>
            ...
            <div className="text-[7px] text-slate-400 mt-0.5 leading-tight">
          ...
          {served && (
            <div className="w-full">
              <button onClick={() => setShowSalami(v => !v)}
                className="text-[10px] text-slate-500 hover:text-slate-700 underline decoration-dotted font-medium">
                {showSalami ? '− Salami batch test' : '+ Salami batch test'}
              </button>
              {showSalami && salamiSlices.length > 0 && (
                <div className="mt-1 text-[10px] text-slate-600 leading-relaxed select-all" onClick={e => {
                  ...
                  <div className="flex justify-between font-bold text-slate-600 border-b border-slate-200 pb-0.5 mb-0.5">
                  ...
                  {salamiSlices.map(s => (
                    <div key={s.slice} className="flex justify-between py-px border-b border-slate-100 last:border-b-0">
                      <span className="w-12 font-bold text-slate-700">#{s.slice}</span>
                  ...
                  <div className="flex justify-between pt-0.5 mt-0.5 border-t border-slate-300 font-bold text-slate-700">
        ...
        <div className="flex flex-col gap-1 min-w-[120px]">
          ...
          {showTdsReport && tds > 0 && (() => {
            ...
            return (
              <div className="text-[6px] text-slate-500 leading-relaxed mt-1 pt-1 border-t border-slate-200 space-y-0.5 select-all" onClick={e => {
                const sel = window.getSelection();
                const range = document.createRange();
                range.selectNodeContents(e.currentTarget);
                sel?.removeAllRanges();
