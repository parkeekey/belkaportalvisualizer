...
export function InfoModal({ onClose }: InfoModalProps) {
  return (
    ...
    >
      <div className="relative bg-white dark:bg-slate-800 dark:bg-slate-800 rounded-2xl shadow-2xl max-w-3xl w-full my-auto">
        ...
        <div className="sticky top-0 z-10 flex items-center justify-between px-7 py-5 bg-gradient-to-r from-slate-800 to-slate-700 rounded-t-2xl">
          <div>
            ...
            <p className="text-slate-300 dark:text-slate-600 text-xs mt-0.5">EC · TDS · Extraction · Coffee Knowledge</p>
          </div>
          <button
            onClick={onClose}
            className="text-slate-300 dark:text-slate-600 hover:text-white text-2xl leading-none font-light transition-colors"
            aria-label="Close"
          >
            ×
          </button>
        ...
        <div className="px-7 py-6 space-y-8 text-slate-700 dark:text-slate-300 dark:text-slate-300 text-sm leading-relaxed">

          {/* ── What is EC ── */}
          <section>
            <h3 className="text-base font-bold text-slate-800 dark:text-white dark:text-white mb-2 flex items-center gap-2">
          ...
          <section>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <div className="bg-red-50 dark:bg-red-900/20 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl p-4">
            ...
            <p className="mt-3 text-xs text-slate-500 dark:text-slate-400 dark:text-slate-400 italic">
          ...
          <section>
            ...
            <div className="space-y-4">
              {/* Use case 1 */}
              <div className="border border-slate-200 dark:border-slate-700 dark:border-slate-700 rounded-xl p-4">
                <p className="font-bold text-slate-800 dark:text-white dark:text-white mb-1">
                ...
                <p className="text-xs text-slate-600 dark:text-slate-400 dark:text-slate-400">
              ...
              <div className="border border-slate-200 dark:border-slate-700 dark:border-slate-700 rounded-xl p-4">
                <p className="font-bold text-slate-800 dark:text-white dark:text-white mb-1">
                  <span className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-amber-100 dark:bg-amber-900/30 text-amber-700 text-xs font-bold mr-2">2</span>
          ...
          {/* ── Credits & Disclaimer ── */}
          <section className="border-t border-slate-100 dark:border-slate-700 dark:border-slate-700 pt-6">
            <h3 className="text-base font-bold text-slate-800 dark:text-white mb-3 flex items-center gap-2">
              <span className="inline-block w-2 h-2 rounded-full bg-slate-400"></span>
              Credits &amp; Disclaimer
            </h3>

            <div className="bg-amber-50 dark:bg-amber-900/20 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 dark:border-amber-800 rounded-xl p-4 text-xs text-amber-900 dark:text-amber-200 mb-4">
            ...
            <div className="grid sm:grid-cols-2 gap-4 text-xs">
              <div className="bg-slate-50 dark:bg-slate-900/50 dark:bg-slate-900/50 rounded-xl p-4 border border-slate-200 dark:border-slate-700 dark:border-slate-700">
                <p className="font-bold text-slate-700 dark:text-slate-300 dark:text-slate-300 mb-2">Creators</p>
                <ul className="space-y-1 text-slate-600 dark:text-slate-400 dark:text-slate-400">
              ...
              <div className="bg-slate-50 dark:bg-slate-900/50 dark:bg-slate-900/50 rounded-xl p-4 border border-slate-200 dark:border-slate-700 dark:border-slate-700">
                <p className="font-bold text-slate-700 dark:text-slate-300 dark:text-slate-300 mb-2">Technical Stack</p>
                <ul className="space-y-1 text-slate-600 dark:text-slate-400 dark:text-slate-400">
            ...
            <div className="mt-4 bg-slate-50 dark:bg-slate-900/50 dark:bg-slate-900/50 rounded-xl p-4 border border-slate-200 dark:border-slate-700 dark:border-slate-700 text-xs text-slate-600 dark:text-slate-400 dark:text-slate-400">
              <p className="font-bold text-slate-700 dark:text-slate-300 dark:text-slate-300 mb-1">Version Info</p>
        ...
        {/* Footer close */}
        <div className="px-7 py-4 bg-slate-50 dark:bg-slate-900/50 dark:bg-slate-900/50 rounded-b-2xl border-t border-slate-100 dark:border-slate-700 dark:border-slate-700 flex justify-end">
          <button
            onClick={onClose}
