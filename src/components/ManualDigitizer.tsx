...
import RecipePourPlanning, { type RecipePourPlanningHandle, type ProfileData } from './RecipePourPlanning';
...
export const ManualDigitizer = forwardRef<ManualDigitizerHandle, ManualDigitizerProps>(({ onDataExtracted, isActive }, ref) => {
  ...
  useImperativeHandle(ref, () => ({
    exportProfile: () => ({
      ...
      ...(() => {
        const p = recipePlanRef.current?.exportProfile();
        return p ? {
          doseWeight: p.doseWeight,
          brewRatio: p.brewRatio,
          totalWaterIn: p.totalWaterIn,
          pourPlan: p.pourPlan,
          grinderName: p.grinderName,
          grindSize: p.grindSize,
          micron: p.micron,
          recipeFinishTimeSec: p.recipeFinishTimeSec,
        } : {
          doseWeight: 15,
          brewRatio: 15,
          totalWaterIn: 225,
  ...
  const recipePlanRef = useRef<RecipePourPlanningHandle>(null);
  ...
  // downloadRecipeReport moved to RecipePourPlanning
    ...
    <div className="max-w-6xl mx-auto p-6">
      <div className="bg-white rounded-lg shadow-lg">
        ...
        <RecipePourPlanning ref={recipePlanRef} ecProps={{
          getECAtTime,
          getCurrentData,
          effectivePourData: effectivePourData || undefined as any,
          totalBrewTime,
        }} profile={{
          doseWeight,
          brewRatio,
