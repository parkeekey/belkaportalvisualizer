...
const PourPlanGraph = forwardRef<HTMLCanvasElement, PourPlanGraphProps>(({ pourPlan, totalBrewTime, ecPoints = [], brewData }, forwardedRef) => {
  ...
  return (
    <div ref={wrapRef} className="w-full" style={{ minHeight: 200 }}>
      <div className="text-xs font-semibold text-slate-500 dark:text-slate-400 dark:text-slate-400 mb-1 uppercase tracking-wider">Pour Plan Visualization</div>
      <canvas
        ...
        className="w-full rounded-lg border border-slate-200 dark:border-slate-700 dark:border-slate-700 bg-white dark:bg-slate-800 dark:bg-slate-800 shadow-sm"
        style={{ height: 200 }}
